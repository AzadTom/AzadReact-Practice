...
function SignUpModel({ children, bg }: ShowModelProp) {
    useEffect(() => {
        ...
        <div className="w-full h-full sm:max-w-xs">
            <div className="w-full h-full flex justify-center relative">
                ...
                <h2 className="absolute bottom-0 left-0 text-[15px] font-medium text-center mx-4 mb-4 text-white z-50">
                    <span className="text-[#FFC107]">5 Mn+ parents </span>are on Parentune for
                    parenting advice. Join the community now
                </h2>
                <div
